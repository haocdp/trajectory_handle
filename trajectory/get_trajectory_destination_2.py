...
def classify_point(filepath, result_filepath):
    ...
    result.close()
    np.save("F:\FCD data/trajectory/allday/youke_1_result_npy", trajectories)


def run():
    filepath = "F:\FCD data/trajectory/allday/youke_1"
    result_filepath = "F:\FCD data/trajectory/allday/youke_1_result"
