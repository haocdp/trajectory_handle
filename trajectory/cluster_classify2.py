...
def classify_point(filepath, result_filepath):
    ...
    with open(filepath) as fr:
        ...
        for index in range(0, single_count):
            line = lines[index]
            if line == '' or line == '\n':
                continue
        ...
        np.save("F:\FCD data\cluster\cluster_region_1.npy", results)
...
def main(argv=None):
    ...
    result_filepath = "F:\FCD data\\trajectory\workday_trajectory\\youke_1_result_1"
