...
def classify_point(filepath, result_filepath):
    ...
    with open(filepath) as fr:
        ...
        for index in range(single_count, single_count * 2):
            line = lines[index]
            if line == '' or line == '\n':
                continue
        ...
        np.save("F:\FCD data\cluster\cluster_region_2.npy", results)
...
def main(argv=None):
    ...
    result_filepath = "F:\FCD data\\trajectory\workday_trajectory\\youke_1_result_2"
