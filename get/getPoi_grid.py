...
def get_representative_poi(input_path, output_path):
    ...
    for file in files:
        ...
        f.close()
    output_file.close()
    np.save("F:\TaxiData\shenzhen_map_poi\\taz_grid_poi\poi_dict", poi_dict)


def run():
    get_representative_poi("F:\TaxiData\shenzhen_map_poi", "F:\TaxiData\shenzhen_map_poi\\taz_grid_poi")
