...
def classify_point(filepath, result_filepath):
    ...
    result.close()
    np.save(base_path + "/trajectory/all_trajectory_result_npy", trajectories)


def run():
    filepath = base_path + "/trajectory/all_trajectory.npy"
    result_filepath = base_path + "/trajectory/all_trajectory_result"
