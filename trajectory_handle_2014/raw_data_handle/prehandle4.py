...
def simplify_line(line):
    ...
    records = line.split(",")
    if not len(records) == 10 or not records[0] == '20141030':
        return '', ''
...
def main(argv=None):
    ...
    divide_trajectory_by_car(base_path + "/taxiData/rawData/10-30", "2014-10-30")
    # divide_trajectory_by_car(base_path + "/taxiData/rawData_test/23", "2014-10-23")
