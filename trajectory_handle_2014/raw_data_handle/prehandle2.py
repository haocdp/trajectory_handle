...
def simplify_line(line):
    ...
    records = line.split(",")
    if not len(records) == 10 or not records[0] == '20141028':
        return '', ''
...
def main(argv=None):
    ...
    divide_trajectory_by_car(base_path + "/taxiData/rawData/10-28", "2014-10-28")
    # divide_trajectory_by_car(base_path + "/taxiData/rawData_test/21", "2014-10-21")
